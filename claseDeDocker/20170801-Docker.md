...
**contenedor** un contenedor es una instancia viva de una imagen. Similar a lo que sería una máquina virtual. Un contenedor corre **un** comando o **un** script nativamente sobre el Kernel del sistema operativo, a diferencia de una máquina virtual que solo tiene acceso a estos recursos de forma virtual a través del Hypervisor. Por tal motivo los contenedores son mucho mas performantes que las máquinas virtuales.
