...
[Siguiente -->](https://github.com/conapps/conapps-iot/blob/master/claseDeDocker/20170815-Storage.md) |
...
![alt text](https://docs.docker.com/engine/userguide/storagedriver/images/container-layers.jpg "Estructura de capas de un contenedor")

La forma en que están estructurados los contenedores presenta un beneficio muy importante, y es que si corro varios conenedores derivados de una misma imagen, el espacio que ocupará cada uno en disco será unicamente la sumatoria de todas las capas superiores (capas de contenedor) mas la imagen, que se sumará una única vez. El diagrama a continuación muestra este concepto gráficamente:

![alt text](https://docs.docker.com/engine/userguide/storagedriver/images/sharing-layers.jpg "Varios contenedores utilizando la misma imagen")
