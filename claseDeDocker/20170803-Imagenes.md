...
Una vez que tenemos el archivo armado, lo único que nos resta por hacer para generar la imágen es guardarlo en un directorio vacío, posicionarnos con el prompt en dicho directorio y ejecutar:
...
```MAINTAINER```
---
Indica el correo de contacto del responsable de la imágen, esto no cumple ninguna función específica pero es una buena práctica incluirlo.
