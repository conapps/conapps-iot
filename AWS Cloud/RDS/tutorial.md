...
3. Elija la instantánea de base de datos que desea restaurar.
4. Seleccione Restaurar instantánea.
Aparecerá la ventana Restore DB Instance.
5. Para Identificador de instancia de DB, escriba el nombre de su instancia de DB restaurada.
