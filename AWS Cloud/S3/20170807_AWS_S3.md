...
También podemos subir objetos a carpetas utilizando la CLI, pero lo haremos de otra forma esta vez. Supongamos queremos subir una estructura de carpetas y archivos que ya tenemos en nuestro equipo:

Vamos a crear la estructura local primero:
```bash
