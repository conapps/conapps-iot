...
![alt text](./images/20170807_S3_Console.png)

### Crear un *bucket*
* En el panel de S3, haga click en *Create Bucket*

![alt text](./images/20170807_S3_bucket_01.png)
...
![alt text](./images/20170807_S3_bucket_02.png)


* Listo, ya puede ver la lista de sus *buckets*
![alt text](./images/20170807_S3_bucket_03.png)
...
Podemos darle permisos a nustros objetos para que los mismos sean accesible púlblicamente, por ej. desde un navegador web. Esto puede resultar útil a la hora de compartir información con otras personas que no tengan cuentas es AWS.
