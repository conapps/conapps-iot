...
También podemos encriptar los datos que se encuentran alojados en S3.
Amazon S3 encripta en forma automática los datos cuando se escriben (o suben) y los desencripta cuando se acceden (o bajan), utilizando Advanced Encryption Standard (AES) con 256-bit symmetric keys.
...
Ref: [Server Access Logging](http://docs.aws.amazon.com/es_es/AmazonS3/latest/dev/ServerLogs.html)
...
* [Amazon S3 Analytics – Storage Class Analysis](http://docs.aws.amazon.com/es_es/AmazonS3/latest/dev/analytics-storage-class.html)
* [Amazon S3 Event Notifications](http://docs.aws.amazon.com/es_es/AmazonS3/latest/dev/NotificationHowTo.html)
* [Amazon S3 Inventory](http://docs.aws.amazon.com/es_es/AmazonS3/latest/dev/storage-inventory.html)
* [Amazon S3 Performance Optimization](http://docs.aws.amazon.com/es_es/AmazonS3/latest/dev/PerformanceOptimization.html)
* [Amazon S3 Transfer Acceleration](http://docs.aws.amazon.com/es_es/AmazonS3/latest/dev/transfer-acceleration.html)
...
---
| [< Anterior](https://github.com/conapps/conapps-iot/blob/master/AWS%20Cloud/S3/20170810_AWS_S3_Parte_2.md) | [Amazon Glacier >](https://github.com/conapps/conapps-iot/blob/master/AWS%20Cloud/S3/20170816_AWS_Glacier.md) |
