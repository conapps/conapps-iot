...
Esto quiere decir que si nosotros quisieramos volver a correr el contenedor, en este punto la imagen se encuentra almacenada localmente y por tanto no es necesario descargarla nuevamente. A modo de ejemplo podemos ejecutar el siguiente comando y comprobar que, a diferencia de lo que sucedió la vez anterior que lo ejecutamos, esta vez el contenedor levanta de forma casi instantánea:
