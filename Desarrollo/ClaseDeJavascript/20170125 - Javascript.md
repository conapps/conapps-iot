...
En el ejercicio anterior vimos como podemos interactuar de forma interactiva con Node.js, escribiendo instrucciones con sintáxis ECMAScript que se ejecutan inmediatamente. Sin embargo, este escenario no es el mas común a la hora de correr aplicaciones en producción donde lo que se utiliza son scripts que ya tienen varias instrucciones escritas y que el motor ejecuta secuencialmente[*](#).
